        ...
        <div className="mt-20 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {benefits.map((benefit) => (
            ...
            >
              ...
              <div className="relative z-10 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-surface-elevated)] dark:bg-[#242b28] shadow-sm ring-1 ring-black/5">
                {benefit.icon}
              </div>
