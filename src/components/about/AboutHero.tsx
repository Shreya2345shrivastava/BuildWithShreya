export function AboutHero() {
  return (
    <section className="relative overflow-hidden bg-[var(--color-bg-ivory)] dark:bg-[#0F1211] py-32 sm:py-48 text-[var(--color-text-primary)] dark:text-white transition-colors duration-300">
