	...
	return (
		<div className="relative flex justify-center lg:justify-end">
			<div className="relative w-full max-w-[740px] fade-in">
				...
				<div className="group relative aspect-[11/10] overflow-hidden rounded-[2.75rem] border border-[color-mix(in_srgb,var(--color-border-soft)_62%,transparent)] bg-[linear-gradient(180deg,rgba(255,250,244,0.96),rgba(245,231,219,0.28))] p-4 shadow-[0_42px_84px_rgba(32,25,19,0.08)] backdrop-blur-[12px] sm:p-6 lg:p-8">
					...
					<div className="relative z-10 h-full w-full">
						...
						<div className="absolute left-[4%] top-[5%] w-[50%] max-w-[330px] float-gentle transition-all duration-700 ease-out hover:-translate-y-2 hover:scale-[1.03] motion-reduce:animate-none">							<Image
								...
								className="h-auto w-full drop-shadow-[0_40px_38px_rgba(32,25,19,0.18)] transition-all duration-700 hover:drop-shadow-[0_55px_55px_rgba(32,25,19,0.22)]"							/>
						</div>

						<div className="absolute right-[7%] bottom-[5%] w-[22%] max-w-[150px] transition-all duration-700 ease-out hover:-translate-y-2 hover:rotate-1">							<div className="absolute inset-0 -z-10 rounded-full bg-[radial-gradient(circle,rgba(255,214,182,0.6),transparent_66%)] blur-2xl" />
							<Image
						...
						<div className="absolute left-[28%] bottom-[3%] w-[28%] max-w-[190px] transition-all duration-700 ease-out hover:-translate-y-2 hover:-rotate-1">							<Image
