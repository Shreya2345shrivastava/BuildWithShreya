...
export function Hero() {
  return (
    <section
      ...
      className="relative flex min-h-[85vh] items-center bg-[var(--color-bg-ivory)] dark:bg-[#131715] pt-16 pb-8 sm:pt-28 sm:pb-16 lg:pt-40 lg:pb-24 border-b border-black/[0.04] overflow-hidden"
    >
