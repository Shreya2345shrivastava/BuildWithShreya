...
export function AuthorSection() {
  return (
    <section id="author" className="border-t border-black/[0.04] bg-[var(--color-bg-ivory)] py-20 sm:py-28 lg:py-32">
      <Container width="wide">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_400px] lg:gap-16 xl:gap-24">
          ...
          <div className="flex flex-col justify-center rounded-[2rem] border border-[var(--color-border-soft)] bg-white p-8 shadow-sm sm:p-10">
